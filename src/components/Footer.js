...
export default function Footer() {
  ...
  </div><div className="footer-base"><p>© AIM Foundation (AI &amp; MedTech Alliance Foundation). All rights reserved.</p><p>Registered under Sections 12A and 80G</p></div></footer>;
}
