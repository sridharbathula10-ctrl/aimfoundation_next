...
export default function Footer() {
  return <footer className="site-footer"><div className="footer-glow" /><div className="footer-inner">
    ...
    <div className="footer-contact"><p className="footer-label">Registered Office</p><address>C 206, Trendset Rythme, Survey No. 7,<br />White Field Road, Kondapur,<br />Telangana 500 084, India</address><div className="social-links"><a href="https://www.linkedin.com/company/ai-medtech-alliance-foundation/about/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer"><FaLinkedinIn aria-hidden="true" /></a><a href="#instagram" aria-label="Instagram"><FaInstagram aria-hidden="true" /></a></div></div>
