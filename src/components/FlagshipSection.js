    ...
    <section className="w-full py-10 lg:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            <ScrollReveal delay={100}><h2 className="text-4xl font-light leading-[0.95] tracking-tight text-[#173c70] md:text-5xl">Amaravati School<br />of Biodesign</h2></ScrollReveal>
